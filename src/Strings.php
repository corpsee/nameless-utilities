...
function transliterate($string)
{
    $transliterate_table = [
        ...
        // Vietnamese
        'ả'=>'a', 'Ả'=>'a', 'ạ'=>'a', 'Ạ'=>'a', 'ằ'=>'a', 'Ằ'=>'a', 'ẳ'=>'a', 'Ẳ'=>'a', 'ẵ'=>'a', 'Ẵ'=>'a', 'ắ'=>'a', 'Ắ'=>'a',
        'ặ'=>'a', 'Ặ'=>'a', 'ầ'=>'a', 'Ầ'=>'a', 'ẩ'=>'a', 'Ẩ'=>'a', 'ẫ'=>'a', 'Ẫ'=>'a', 'ấ'=>'a', 'Ấ'=>'a', 'ậ'=>'a', 'Ậ'=>'a',
        'ẻ'=>'e', 'Ẻ'=>'e', 'ẽ'=>'e', 'Ẽ'=>'e', 'ẹ'=>'e', 'Ẹ'=>'e', 'ề'=>'e', 'Ề'=>'e', 'ể'=>'e', 'Ể'=>'e', 'ễ'=>'e', 'Ễ'=>'e', 'ế'=>'e', 'Ế'=>'e', 'ệ'=>'e',
 ...
 * @return string
 */
function standardize($string, $separator = '_')
{
    $string = \Nameless\Utilities\Strings\transliterate($string);
    $string = trim($string);
